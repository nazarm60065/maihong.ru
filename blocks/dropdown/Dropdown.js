export class Dropdown {
  ...
  init() {
    ...
    this.dropdown = this.selectors.el ? this.selectors.el : document.querySelector(this.selectors.dropdown)
  ...
  dropdownExpand(dropdown) {
    ...
    if (this.params.onOpen && typeof this.params.onOpen === 'function') {
  ...
  valueClickHandler(valueEl) {
    ...
    if (!valueEl.classList.contains(this.classes.valueDisabled)) {
      const value = valueEl.dataset['value']

      let currentValue = dropdown.querySelector(
  ...
  documentClickHandler(event) {
    if (this.params._active) {
      const target = event.target,
        expandedDropdown = target.closest(this.selectors.dropdown + ',.' + this.classes.dropdownExpand)
  ...
  dropdownReset() {
    let selectedValue = this.dropdown.querySelector(
        '.' + this.classes.valueSelected
      ),
